        ...
        <div class="segments">
            ...
            <div class="side-bar">
                <div class="profile">
                    ...
                    <div class="desc">
                        <h4>Ebube Anthony <span>Egolum</span></h4>
                ...
                <div class="other-details">
                    ...
                    <p>Languages: <span>English, Igbo</span></p>
                    <p>Residence: <span>Anambra</span></p>
                ...
                <div class="skills">
                    <h6>Skills</h6>
                    <div class="skill">
                        <div class="skill-name">HTML <span>90%</span></div>
                        <div class="skill-bar">
                            <div class="skill-per" style="max-width:90%"></div>
                        </div>
                    </div>

                    <div class="skill">
                        <div class="skill-name">CSS <span>85%</span></div>
                        <div class="skill-bar">
                            <div class="skill-per" style="max-width:85%"></div>
                        </div>
                    </div>

                    <div class="skill">
                        <div class="skill-name">Javascript <span>60%</span></div>
                        <div class="skill-bar">
                    ...
                    <div class="skill">
                        <div class="skill-name">PHP <span>80%</span></div>
                        <div class="skill-bar">
                ...
                <div class="extra-skills">
                    <h6>Extra Skills</h6>
                    <p><span><i class="fa-solid fa-check"></i></span> WordPress</p>
                    <p><span><i class="fa-solid fa-check"></i></span> Sass, Bootstrap</p>
                    <p><span><i class="fa-solid fa-check"></i></span> JQuery, Ajax</p>
                    <p><span><i class="fa-solid fa-check"></i></span> GIT knowledge</p>
                </div>

                <div class="cv-download">
                    <button><a href="#"><i class="fa-solid fa-download"></i> Download CV </a></button>
                </div>
            </div>
            ...
            <div class="main-body">
                ...
                <div class="resume section" id="resume">
                    ...
                    <div class="resume-details">
                        <div>
                            <p><span>Address:</span> Awka, Anambra State, Nigeria.</p>
                            <p><span>Phone:</span> +2348169021239</p>
                            <p><span>Email:</span> egolumaer@gmail.com</p>
                        </div>
                        <div>
                            <p><span>GitHub:</span> www.github.com/Tochard</p>
                            <p><span>Linkedin:</span> www.linkedin.com/egolumanthony/</p>
                        </div>
                    </div>
                ...
                <div class="footer">
                    <footer>
                        <p> &copy; 2022 All Rights Reserved. <span>Email: egolumaer@gmail.com</span></p>
                    </footer>
                </div>
            </div>
